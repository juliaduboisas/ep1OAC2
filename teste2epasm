...
loop:
    ...
    sw $t7, 0($t6)                                   # Armazenar o primeiro elemento
    addi $a0, $a0, 4                                 # Avançar para o próximo elemento do array

    lw $t7, 0($a0)                                   # Carregar o próximo elemento
    sw $t7, 4($t6)                                   # Armazenar o segundo elemento
    addi $a0, $a0, 4                                 # Avançar para o próximo elemento do array
    addi $t4, $t4, 2                                 # Incrementar o índice do array por 2 (já que estamos armazenando dois elementos)

    addi $t0, $t0, 1                                 # Incrementar o índice da matriz (linha)
